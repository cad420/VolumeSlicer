...
inline void CreateCUDATexture3D(cudaExtent textureSize, cudaArray **ppCudaArray,
                                cudaTextureObject_t *pCudaTextureObject)
{
...
inline void UpdateCUDATexture2D(uint8_t *data, cudaArray *pCudaArray, uint32_t x_length, uint32_t y_length,
