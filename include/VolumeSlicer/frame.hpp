...
class Image
{
  public:
    ...
    template <uint8_t n> std::array<T, n> at(int row, int col) const
    {
...
class VS_EXPORT Image<Color4b>
{
  ...
  public:
    ...
    Image(uint32_t width, uint32_t height, const Color4b &init_value = Color4b{}) : Image(width, height, UnInit())
    {
        for (size_t i = 0; i < num; i++)
