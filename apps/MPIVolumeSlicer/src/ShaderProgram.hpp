...
public:
    ...
    void setUIArray(const std::string&name,uint32_t* data,int count) const;
...
inline void Shader::setUInt(const std::string &name, uint32_t value) const {
...
inline void Shader::setUIArray(const std::string &name, uint32_t *data, int count) const {
